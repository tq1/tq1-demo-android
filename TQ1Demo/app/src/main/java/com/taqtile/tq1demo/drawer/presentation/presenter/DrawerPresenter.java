...
import com.taqtile.tq1demo.drawer.domain.usecase.GetUnreadNotificationsCountUseCase;
...
public class DrawerPresenter implements DrawerContract.Presenter {
    ...
    private final GetUnreadNotificationsCountUseCase mGetUnreadNotificationsCountUseCase;
    ...
    public DrawerPresenter(@NonNull BaseUseCaseHandler useCaseHandler,
                           ...
                           @NonNull GetUnreadNotificationsCountUseCase getUnreadNotificationsCountUseCase,
        ...
        mGetUnreadNotificationsCountUseCase = checkNotNull(getUnreadNotificationsCountUseCase,
                "GetUnreadNotificationsCount use case cannot be null!");
    ...
    private void updateUnreadNotificationsCounter() {
        mUseCaseHandler.execute(mGetUnreadNotificationsCountUseCase,
                new GetUnreadNotificationsCountUseCase.RequestValues(),
                new BaseUseCase.UseCaseCallback<GetUnreadNotificationsCountUseCase.ResponseValue>() {
                    @Override
                    public void onSuccess(GetUnreadNotificationsCountUseCase.ResponseValue responseValue) {
                        mView.updateUnreadNotificationsCounter(responseValue.getUnreadNotificationsCount());
                    }

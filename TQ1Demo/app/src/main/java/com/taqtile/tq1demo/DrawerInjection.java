...
public class DrawerInjection {
    ...
    public static GetUnreadNotificationsCountUseCase provideGetUnreadNotificationsCountUseCase(@NonNull Activity activityContext) {
        return new GetUnreadNotificationsCountUseCase(Injection.provideNotificationRepository(activityContext));
    }
}
